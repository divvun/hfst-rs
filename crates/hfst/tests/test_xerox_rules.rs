...
fn compose_minimize(left: &HfstTransducer, right: &HfstTransducer) -> HfstTransducer {
...
fn test8(type_: ImplementationType) {
...
fn before_test1(type_: ImplementationType) {
    let tok = HfstTokenizer::new();
...
fn after_test1(type_: ImplementationType) {
    let tok = HfstTokenizer::new();
    let left = HfstTransducer::new_tokenized("a", &tok, type_);
    let right = HfstTransducer::new_tokenized("b", &tok, type_);
...
fn restriction_test1(type_: ImplementationType) {
...
fn restriction_test1a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("a", &tok, type_);
...
fn restriction_test1b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("a", &tok, type_);
...
fn restriction_test2(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn restriction_test3(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn restriction_test3a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("a", &tok, type_);
...
fn restriction_test3b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn restriction_test3c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("ab", &tok, type_);
    let epsilon = HfstTransducer::new_tokenized("@_EPSILON_SYMBOL_@", &tok, type_);
...
fn restriction_test4(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("a", &tok, type_);
...
fn restriction_test5(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("a", &tok, type_);
    let epsilon = HfstTransducer::new_tokenized("@_EPSILON_SYMBOL_@", &tok, type_);
...
fn restriction_test5a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("a", &tok, type_);
    let epsilon = HfstTransducer::new_tokenized("@_EPSILON_SYMBOL_@", &tok, type_);
...
fn restriction_test6(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    let center = HfstTransducer::new_tokenized("ab", &tok, type_);
    let epsilon = HfstTransducer::new_tokenized("@_EPSILON_SYMBOL_@", &tok, type_);
...
fn restriction_test7(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn restriction_test8(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test10a(type_: ImplementationType) {
    let tok = HfstTokenizer::new();
...
fn test10b(type_: ImplementationType) {
    let tok = HfstTokenizer::new();
...
fn test9a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test9b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test1(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test1b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test1c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test1d(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
...
fn test2a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_UNKNOWN_SYMBOL_@");
    tok.add_multichar_symbol("@_IDENTITY_SYMBOL_@");
...
fn test2b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test2c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_UNKNOWN_SYMBOL_@");
    tok.add_multichar_symbol("@_IDENTITY_SYMBOL_@");
...
fn test3a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test3b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test3c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test3d(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test4a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test4b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test4c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test6a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test6b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test6c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_LM_@");
    tok.add_multichar_symbol("@_RM_@");
...
fn test7a(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test7b(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test7c(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test7d(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test7e(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_IDENTITY_SYMBOL_@");
...
fn test7f(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test7g(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
fn test7h(type_: ImplementationType) {
    let mut tok = HfstTokenizer::new();
    tok.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    tok.add_multichar_symbol("@_IDENTITY_SYMBOL_@");
