...
fn main() {
    ...
    let tr =
        HfstBasicTransition::new_symbols(0, EPS.to_string(), EPS.to_string(), -0.5, g.coder_mut());
    ...
    let tr =
        HfstBasicTransition::new_symbols(1, "a".to_string(), "b".to_string(), 0.0, g2.coder_mut());
