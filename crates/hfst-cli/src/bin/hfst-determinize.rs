...
use hfst::hfst_transducer::{HfstTransducer, get_encode_weights, set_encode_weights};
...
unsafe fn print_usage() {
    unsafe {
        ...
        fput(globals::message_out(), "Command-specific options:\n");
        fput(
            globals::message_out(),
    ...
    unsafe {
        ...
        loop {
            ...
            long_options.push(getopt::Option {
                name: CString::new("encode-weights").unwrap().into_raw(),
                has_arg: 0,
...
unsafe fn process_stream(
    ...
    unsafe {
        ...
        while instream.is_good() {
            ...
            if transducer_n == 1 {
                verbose_printf(&format!("Determinizing {}...\n", inputname));
            } else {
